---
title: "Speech Delays in Toddlers: Red Flags & When to Worry"
description: "How to tell normal toddler speech variation from a real delay — ASHA red flags by age, when to seek evaluation, and what early intervention looks like."
publishDate: 2026-06-24
lastReviewed: 2026-04-23
slug: "speech-delays-when-to-worry"
category: "development"
tags: ["speech delay", "language delay", "toddler", "early intervention", "ASHA"]
author: "Vega Lin"
...
For a fuller language picture, see our [first words timeline](/blog/first-words-timeline/) and [baby language development timeline](/blog/baby-language-development-timeline/).
...
1. Call your state's EI program or ask your pediatrician for a referral
2. Initial evaluation (free) determines if your child qualifies
3. If qualified, services include speech-language therapy, sometimes occupational and physical therapy
4. Therapy happens at home, daycare, or a clinic
5. Family is part of the therapy plan
...
For more strategies, see our [first words timeline](/blog/first-words-timeline/) and [baby sign language guide](/blog/baby-sign-language-first-signs/).
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "My 2-year-old has 30 words. Should I worry?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Possibly. The benchmark is 50 words by 24 months. A 24-month-old at 30 words isn't catastrophic, but it's worth a free speech evaluation, especially if 2-word combinations haven't started."
      }
    },
    {
      "@type": "Question",
      "name": "My toddler understands everything but barely talks. Is that a delay?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "This pattern - strong receptive, weak expressive - describes a late talker. About half catch up without intervention, half don't. Evaluation at 24 months is the safest move."
      }
    },
    {
      "@type": "Question",
      "name": "Can ear infections cause speech delay?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Recurrent ear infections cause temporary hearing loss, which can delay speech sound acquisition. If your child has had multiple ear infections, ask about a hearing test."
      }
    },
    {
      "@type": "Question",
      "name": "Will speech therapy fix it?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Speech therapy is highly effective for most causes of speech and language delay, especially when started before age 3. Severity and underlying cause affect outcomes, but therapy almost always helps."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Varies widely. Mild delays may resolve with 3-6 months of weekly therapy. More complex issues may need 1-3+ years of support. Early start = shorter total duration."
      }
    }
  ]
}
...
- Centers for Disease Control and Prevention. (2024). [Important Milestones: Your Child by Two Years](https://www.cdc.gov/ncbddd/actearly/milestones/milestones-2yr.html). CDC.
- American Speech-Language-Hearing Association. (2023). [Late Language Emergence](https://www.asha.org/practice-portal/clinical-topics/late-language-emergence/). ASHA.
