...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "BlogPosting",
      "@id": "https://baby.chparenting.com/blog/korean-baby-names/#article",
      "headline": "40 Korean Baby Names with Meanings",
      "description": "Discover 40 beautiful Korean baby names for boys and girls with meanings, pronunciation guides, and insights into Korea's unique naming traditions.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://baby.chparenting.com/blog/korean-baby-names/"
      },
      "wordCount": 2000,
      "articleSection": "Names",
      "keywords": ["Korean names", "baby names", "Korean baby names", "Hangul names", "Asian names"],
      "inLanguage": "en-US"
    },
    {
      "@type": "Person",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://baby.chparenting.com/blog/korean-baby-names/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How does the hanja system work in Korean naming?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most Korean given names use hanja (Chinese characters) to convey meaning. Each character has a specific meaning and pronunciation. A two-syllable name combines two characters, creating a layered meaning. Parents often spend considerable time selecting the perfect combination."
          }
        },
        {
          "@type": "Question",
          "name": "What is a generation name in Korean families?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A generation name (dollimja) is a shared syllable used by all members of the same generation within an extended family. This syllable follows a predetermined cycle based on the five Chinese elements. This tradition helps identify family connections and generational relationships at a glance."
          }
        },
        {
          "@type": "Question",
          "name": "Can Korean names be written without hanja?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, since the 1990s Korean law has allowed given names to be written purely in Hangul without corresponding hanja characters. This has enabled the rise of pure Korean names that use native Korean words like Haneul (sky), Bom (spring), and Nuri (world)."
          }
        }
      ]
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://baby.chparenting.com/blog/korean-baby-names/#breadcrumb",
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 3, "name": "Korean Baby Names", "item": "https://baby.chparenting.com/blog/korean-baby-names/"}
      ]
    }
  ]
}
