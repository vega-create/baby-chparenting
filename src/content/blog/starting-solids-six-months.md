---
title: "Starting Solids at 6 Months: Complete Pediatric Guide"
description: "A pediatric guide to starting solids at 6 months — readiness signs, first foods, allergen introduction, portions, and safety tips backed by AAP & CDC."
publishDate: 2026-06-09
lastReviewed: 2026-04-23
slug: "starting-solids-six-months"
category: "feeding"
...
|---|---|---|
| Iron-fortified infant cereal | Mix with breast milk or formula | Oat or multigrain preferred over rice |
| Pureed meat (beef, chicken, turkey) | Smooth puree, no added salt | Excellent heme iron source |
| Lentils or beans | Smashed or pureed | Pair with vitamin C for absorption |
| Egg yolk | Hard-boiled, mashed | Whole eggs are also fine |
| Tofu | Mashed soft tofu | Plant iron source |
...
| Age | Solid meals/day | Approximate volume per meal |
|---|---|---|
| 6 months | 1–2 | 1–2 tablespoons |
| 7–8 months | 2–3 | 2–4 tablespoons |
| 9–11 months | 3 + 1 snack | 4–6 tablespoons |
| 12 months | 3 + 2 snacks | About 1/2 cup |
...
For more detail, see our guide on [baby food allergies: signs and prevention](/blog/baby-food-allergies-signs-prevention/).
...
If you want a deeper dive, read our [baby-led weaning complete guide](/blog/baby-led-weaning-complete-guide/).
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Should I start with cereal or vegetables?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Either is fine. Current guidance prioritizes iron-rich foods, which can be cereal, meat, or beans. There is no medical reason to start with rice cereal first."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to offer water with meals?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, you can offer a small amount (1-2 ounces) of water in an open cup or straw cup with meals once solids start. Milk is still the main hydration source."
      }
    },
    {
      "@type": "Question",
      "name": "What if my baby does not seem interested at 6 months?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Wait a week and try again. Sit baby with you at family meals so they can watch. Most babies become curious after a few days of seeing food."
      }
    },
    {
      "@type": "Question",
      "name": "Can I make my own baby food?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely. Steam vegetables, blend with breast milk or water, and freeze in ice cube trays. Homemade is often cheaper and just as nutritious as store-bought, with no added salt or sugar."
      }
    },
    {
      "@type": "Question",
      "name": "When can I introduce spices?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "From day one. Mild herbs and spices like cinnamon, garlic, basil, cumin, and turmeric are safe. Just skip salt, hot peppers, and very strong flavors at first."
      }
    }
  ]
}
...
- Centers for Disease Control and Prevention. (2024). [When, What, and How to Introduce Solid Foods](https://www.cdc.gov/nutrition/infantandtoddlernutrition/foods-and-drinks/when-to-introduce-solid-foods.html). CDC.
