---
title: "Weaning from Bottle to Sippy Cup: Step-by-Step"
description: "How to wean baby from bottle to sippy cup or open cup — best age to start, types of cups, gradual transition steps, and pediatric advice for stubborn drinkers."
publishDate: 2026-06-12
lastReviewed: 2026-04-23
slug: "weaning-bottle-to-cup"
category: "feeding"
tags: ["weaning bottle", "sippy cup", "open cup", "toddler feeding", "transitions"]
author: "Vega Lin"
authorUrl: "https://baby.chparenting.com/author/vega-lin/"
image: "https://images.pexels.com/photos/6849541/pexels-photo-6849541.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750"
draft: false
---
...
1. **Let them choose the cup**: Take them shopping and let them pick the color or character
2. **Make a ritual**: "Big kids drink from cups!" Have a small celebration when bottles go away
3. **Cold turkey for older toddlers**: For some 2-year-olds, gradual fades drag out the pain. A 3-day cold-turkey transition is faster.
4. **Donate the bottles together**: Pack them into a box and "send them to babies who need them"
5. **Watch for sneaky bottle reappearances** at grandma's house or daycare — coordinate with caregivers
...
For more on the breast-to-cup transition, see our [baby-led weaning complete guide](/blog/baby-led-weaning-complete-guide/).
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What if my toddler refuses the cup completely?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Offer cups with a fun audience - let them watch siblings or you drink from cups. Try different cup types over a 2-week period. If after a month they still refuse all cups, talk to your pediatrician - there may be an oral motor issue."
      }
    },
    {
      "@type": "Question",
      "name": "Should I use sippy cups at all?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sippy cups (especially hard-spout) are convenient but should not be the long-term goal. Use them as a bridge if needed, then move to straw or open cups by 18 months."
      }
    },
    {
      "@type": "Question",
      "name": "What about the comfort aspect of the bedtime bottle?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The bottle itself is not magical - the cuddle is. Keep the snuggle, the books, the rocking. Replace just the bottle with a cup of milk earlier in the routine."
      }
    },
    {
      "@type": "Question",
      "name": "How much milk does my toddler need from a cup?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "About 16-24 oz of whole milk per day from 12-24 months. More than 24 oz can cause iron deficiency."
      }
    },
    {
      "@type": "Question",
      "name": "My toddler still wants the bottle at 2 years. Is it too late?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It is not too late, but it will be harder. Most pediatricians recommend a firmer approach: pick a date, prepare your toddler, and go cold turkey with extra comfort and consistency."
      }
    }
  ]
}
...
- American Academy of Pediatrics. (2024). [Discontinuing the Bottle](https://www.healthychildren.org/English/ages-stages/baby/feeding-nutrition/Pages/Discontinuing-the-Bottle.aspx). HealthyChildren.org.
- American Academy of Pediatric Dentistry. (2023). [Policy on Early Childhood Caries](https://www.aapd.org/research/policy-center/). AAPD.
...
- Mayo Clinic. (2024). [Weaning Your Child from Breastfeeding](https://www.mayoclinic.org/healthy-lifestyle/infant-and-toddler-health/in-depth/weaning/art-20048440). Mayo Clinic.
