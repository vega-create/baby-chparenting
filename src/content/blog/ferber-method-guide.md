...
1. Bath (optional but calming)
2. Pajamas and diaper
3. Feed (NOT to sleep — end feeding before baby is drowsy)
4. 1–2 short books or songs
5. Place in crib AWAKE
6. Say goodnight and leave the room

### Step 2: Night 1 Protocol

1. Complete the bedtime routine.
2. Place baby in the crib awake. Say "I love you, goodnight."
3. Leave the room.
4. **Start the timer.** Wait 3 minutes before the first check-in.
5. **First check-in (3 min):** Enter the room. Do NOT pick baby up. Briefly reassure with words ("You're okay, I love you, it's time for sleep") and a brief pat. Stay 1–2 minutes MAX. Leave.
6. **Wait 5 minutes.** Then do the second check-in (same brief reassurance).
7. **Wait 10 minutes.** Continue with 10-minute intervals until baby falls asleep.
...
![Nursery with dim lighting](https://images.pexels.com/photos/3661263/pexels-photo-3661263.jpeg?auto=compress&cs=tinysrgb&w=800)
...
Track your Ferber method progress with our [Sleep Tracker](/tools/sleep-tracker/) — log crying duration each night to see the trend.
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "BlogPosting",
      "@id": "https://baby.chparenting.com/blog/ferber-method-guide/#article",
      "headline": "Ferber Method: Complete Step-by-Step Guide",
      "description": "Complete Ferber method guide with night-by-night check-in intervals table, step-by-step instructions, common mistakes to avoid, and expected success timeline.",
      ...
      "keywords": ["Ferber method", "graduated extinction", "sleep training", "check-in intervals"],
      "inLanguage": "en-US"
    },
    {
      "@type": "Person",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://baby.chparenting.com/blog/ferber-method-guide/#faq",
      "mainEntity": [
        {"@type": "Question", "name": "Does the Ferber method cause psychological harm?", "acceptedAnswer": {"@type": "Answer", "text": "No. A 2012 follow-up study in Pediatrics found no differences in emotional, behavioral, or stress-related outcomes 5 years after sleep training. The AAP confirms behavioral sleep interventions are safe."}},
        {"@type": "Question", "name": "What if my baby vomits from crying?", "acceptedAnswer": {"@type": "Answer", "text": "Calmly clean up with minimal interaction (dim lights, no talking), then leave and resume the check-in schedule. Vomiting usually only happens once or twice and is not harmful."}},
        {"@type": "Question", "name": "Can I modify the Ferber intervals?", "acceptedAnswer": {"@type": "Answer", "text": "Absolutely. Dr. Ferber himself says the intervals are guidelines. You can start shorter or go longer depending on your baby's temperament. Some babies do better with fewer check-ins."}},
        {"@type": "Question", "name": "How do I handle early morning wakings during Ferber?", "acceptedAnswer": {"@type": "Answer", "text": "Treat early morning wakings like nighttime wakings using the check-in schedule. Don't get baby up until your designated wake time to help set the circadian rhythm."}}
      ]
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://baby.chparenting.com/blog/ferber-method-guide/#breadcrumb",
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 3, "name": "Ferber Method Guide", "item": "https://baby.chparenting.com/blog/ferber-method-guide/"}
      ]
    }
  ]
}
