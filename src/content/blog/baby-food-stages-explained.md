---
title: "Baby Food Stages 1, 2, 3: What's the Difference"
description: "Confused by baby food stages 1, 2, and 3? Here's what each stage means, when to start, textures, ages, and how to progress your baby safely from purees to table food."
publishDate: 2026-06-10
lastReviewed: 2026-04-23
slug: "baby-food-stages-explained"
category: "feeding"
tags: ["baby food stages", "purees", "infant feeding", "stage 1", "stage 2", "stage 3"]
author: "Vega Lin"
...
1. To accept non-milk flavors
2. To move food around the mouth without spitting it out
3. To handle thicker textures and small lumps
4. To chew (yes, even without teeth) and swallow safely
5. To self-feed using fingers and utensils
...
This is also a great stage to start offering soft finger foods alongside purees, even if you mostly spoon-feed. See our [baby-led weaning complete guide](/blog/baby-led-weaning-complete-guide/) for finger food ideas.
...
1. **Move on within 4 weeks** of starting Stage 1 if baby is doing well
2. **Mix stages**, e.g., add a few small pieces of soft fruit to a smooth puree
3. **Offer finger foods alongside purees** from 6–7 months (with safe preparation)
4. **Mash with a fork instead of blending** by 8 months
5. **Watch for boredom** — if baby pushes purees away, they may be ready for more texture
...
For a complete list of foods to avoid by age, see our [choking hazards by age guide](/blog/choking-hazards-by-age/).
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Are baby food stages official?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Stage labels are a marketing convention, not regulated by the FDA, AAP, or any health authority. They roughly correspond to texture and age, but brands use them inconsistently."
      }
    },
    {
      "@type": "Question",
      "name": "Can I skip Stage 1 and go straight to finger foods?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. This is essentially baby-led weaning. As long as your baby shows readiness signs and you prepare foods safely, you do not have to do purees at all."
      }
    },
    {
      "@type": "Question",
      "name": "How long should I stay on each stage?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most babies move through Stage 1 in 2-4 weeks, Stage 2 over 2-3 months, and Stage 3 until around 12 months. Move as soon as your baby handles the current texture comfortably."
      }
    },
    {
      "@type": "Question",
      "name": "My baby gags on Stage 2. Should I go back to Stage 1?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Some gagging is normal as babies adjust to new textures. Try thinning Stage 2 slightly with breast milk or formula. If gagging is severe or causes vomiting at every meal, talk to your pediatrician."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to buy stage-labeled food?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. You can blend and mash family foods at home and progress textures as your baby is ready. The stages are a helpful guide, not a requirement."
      }
    }
  ]
}
...
- American Academy of Pediatrics. (2023). [Sample Menu for an 8 to 12 Month Old](https://www.healthychildren.org/English/ages-stages/baby/feeding-nutrition/Pages/Sample-One-Day-Menu-for-an-8-to-12-Month-Old.aspx). HealthyChildren.org.
