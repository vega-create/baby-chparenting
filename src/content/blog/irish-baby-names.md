...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "BlogPosting",
      "@id": "https://baby.chparenting.com/blog/irish-baby-names/#article",
      "headline": "50 Irish Baby Names: Meanings & Pronunciation",
      "description": "Explore 50 beautiful Irish baby names with meanings and pronunciation guides. Discover Gaelic naming traditions and find the perfect Celtic name for your baby.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://baby.chparenting.com/blog/irish-baby-names/"
      },
      "wordCount": 2000,
      "articleSection": "Names",
      "keywords": ["Irish names", "baby names", "Gaelic names", "Celtic names", "Irish baby names"],
      "inLanguage": "en-US"
    },
    {
      "@type": "Person",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://baby.chparenting.com/blog/irish-baby-names/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Why are Irish names spelled so differently from how they sound?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Irish names follow the phonetic rules of the Gaelic language, which has a completely different sound system from English. In Irish, certain letter combinations have consistent pronunciations that simply differ from English conventions. Once you learn the basic patterns, Irish name pronunciation becomes much more predictable."
          }
        },
        {
          "@type": "Question",
          "name": "What are the most popular Irish baby names right now?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In Ireland, Fiadh and Grace lead for girls, while Jack and Noah are top boy names. Among specifically Gaelic names, Fiadh, Saoirse, and Caoimhe are trending for girls, while Cillian, Oisin, and Fionn are popular choices for boys."
          }
        },
        {
          "@type": "Question",
          "name": "Do I need to be Irish to use an Irish name?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. Irish names are used and loved by families of all backgrounds around the world. While it is respectful to learn the correct pronunciation and understand the name's meaning and cultural context, there is no cultural expectation that only Irish families can use these names."
          }
        }
      ]
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://baby.chparenting.com/blog/irish-baby-names/#breadcrumb",
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 3, "name": "Irish Baby Names", "item": "https://baby.chparenting.com/blog/irish-baby-names/"}
      ]
    }
  ]
}
